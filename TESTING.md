...
| `CatalogRepositoryTests.cs` | `ReclassifyFranchiseAsync`, the franchise-rule fingerprint accessors, `ListAllGameIdsAndTitlesAsync`, and `UpsertGameAsync` keeping a stored `content_kind` when a later upsert of the same game carries none |
